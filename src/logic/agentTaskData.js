...
export const AI_TASK_DATA = [
  ...
  },
  {
    ...
    get name() { return store.settings.language === 'en' ? this.name_en : this.name_ko; },
    desc_ko: '활성화 되있는 동안 매시간마다 10% 확률로 500CR을 얻습니다.',
    desc_en: 'While this is active, 10% chance to earn 500 CR every hour.',
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
  ...
  },
  {
    ...
    get name() { return store.settings.language === 'en' ? this.name_en : this.name_ko; },
    desc_ko: '활성화 되있는 동안 매시간마다 10% 확률로 2500CR을 얻습니다.',
    desc_en: 'While this is active, 10% chance to earn 2500 CR every hour.',
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
  ...
  },
  {
    ...
    get name() { return store.settings.language === 'en' ? this.name_en : this.name_ko; },
    desc_ko: '활성화 되있는 동안 매시간마다 10% 확률로 10,000 CR을 얻습니다. (1% 확률로 벌금을 물게 될 수도 있습니다!)',
    desc_en: 'While this is active, 10% chance to earn 10,000 CR every hour. (1% chance of getting a fine!)',
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    ...
    duration: 0,
    cooldown: 3 * 24 * 60,
    effect: [{ type: 'add_bankroll', amount: 10000 }, { type: 'penalty_amount', id: 'SECURITY_DETECTION', probability: 0.01, amount: 50000 }],
  ...
  },
  {
    ...
    get name() { return store.settings.language === 'en' ? this.name_en : this.name_ko; },
    desc_ko: '활성화 되있는 동안 매시간마다 30% 확률로 50,000 CR을 얻습니다. (6% 확률로 높은 벌금을 물게 될 수도 있습니다!)',
    desc_en: 'While this is active, 30% chance to earn 50,000 CR every hour. (6% chance of getting a huge fine!)',
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    desc_detail_ko: '확실하게 불법이 맞습니다...',
    ...
    duration: 0,
    cooldown: 5 * 24 * 60,
    effect: [{ type: 'add_bankroll', amount: 50000 }, { type: 'penalty_amount', id: 'SECURITY_DETECTION', probability: 0.06, amount: 250000 }],
