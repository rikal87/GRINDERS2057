...
//   const mapPosToGTO = (pos, pCount = 6) => {
//     if (!pos) return 'UTG';
...
//     if (pCount <= 4) {
//       if (p.includes('UTG') || p.includes('EP')) return 'CO';
//     } else if (pCount === 5) {
//       if (p.includes('UTG') || p.includes('EP')) return 'MP';
//       if (p.includes('MP') || p.includes('HJ')) return 'CO';
//     }
...
//     const aggPosGTO = mapPosToGTO(aggPos, playerCount);
...
//   } else {
//     // [v11] Preflop/Postflop strategies have been moved to strategies/ folder.
//     // [v11] GTO matrix parsing has been moved to tools/aiBrainRangeTool.js.
//   }
