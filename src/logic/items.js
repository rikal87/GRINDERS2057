...
export const ITEM_DATA = [
...

  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('show_me_your_bluff')]
  },
  {
  ...
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('session_profit_bonus'), getItemEffect('quantum_fold')]
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('session_profit_bonus'), getItemEffect('winner_master')]
  },
  {
  ...
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('emergency_fund'), getItemEffect('session_profit_bonus')]
  },
  {
    id: 'lucky_cat_gold',
    name_ko: '황금 마네키네코',
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('session_profit_bonus'), getItemEffect('session_profit_bonus')]
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('loyalty_card'), getItemEffect('session_profit_bonus')]
  },
  {
  ...
  // --- T4 items (50000 - 100000 CR) ---
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('omen'), getItemEffect('double_down')]
  },
  {
  ...
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('session_profit_bonus'), getItemEffect('session_profit_bonus'), getItemEffect('session_profit_bonus')]
  },
  {
    id: 'fusion_core_mini',
    name_ko: '소형 융합 코어',
  ...
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('buy_in_multiply'), getItemEffect('session_profit_bonus'), getItemEffect('session_profit_bonus')]
  },
  {
  ...
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getRndItemBucket, getRndItemBucket, getRndItemBucket, getRndItemBucket]
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('quantum_luck'), getItemEffect('quantum_luck'), getItemEffect('quantum_luck'), getItemEffect('quantum_luck')]
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('club_collector'), getItemEffect('spade_collector'), getItemEffect('heart_collector'), getItemEffect('diamond_collector')]
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('omen'), getItemEffect('lucky_7_collector'), getItemEffect('dopamine_addiction'), getItemEffect('dopamine_addiction')]
  },
  {
  ...
  },
  {
    ...
    get desc() { return store.settings.language === 'en' ? this.desc_en : this.desc_ko; },
    effects: [getItemEffect('royal_flush_master'), getRndItemBucket, getRndItemBucket, getRndItemBucket]
  },
  {
