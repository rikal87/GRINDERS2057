...
export const EVENT_ID = {
  ...
  MAX_BREAK_CONTRACT_GAMBLING_WITH_ME: 'MAX_BREAK_CONTRACT_GAMBLING_WITH_ME',
  ...
  MAX_BANKRUPT_ACCEPT_RESCUE_LOW_RELATIONSHIP: 'MAX_BANKRUPT_ACCEPT_RESCUE_LOW_RELATIONSHIP',
  MAX_BANKRUPT_REFUSE_RESCUE_LOW_RELATIONSHIP: 'MAX_BANKRUPT_REFUSE_RESCUE_LOW_RELATIONSHIP',
  MAX_BANKRUPT_HAS_DEBT: 'MAX_BANKRUPT_HAS_DEBT',
  MAX_BANKRUPT_HAS_DEBT_LOW_RELATION: 'MAX_BANKRUPT_HAS_DEBT_LOW_RELATION',
  ...
  MAX_SIGN_CONTRACT_GAMBLING_WITH_ME: 'MAX_SIGN_CONTRACT_GAMBLING_WITH_ME',
  ...
  FLORENCE_BANKRUPT_HAS_DEBT_LOW_RELATION: 'FLORENCE_BANKRUPT_HAS_DEBT_LOW_RELATION',
  FLORENCE_BANKRUPT_REFUSE_RESCUE: 'FLORENCE_BANKRUPT_REFUSE_RESCUE',
  FLORENCE_BANKRUPT_ACCEPT_RESCUE_LOW_RELATIONSHIP: 'FLORENCE_BANKRUPT_ACCEPT_RESCUE_LOW_RELATIONSHIP',
  FLORENCE_BANKRUPT_REFUSE_RESCUE_LOW_RELATIONSHIP: 'FLORENCE_BANKRUPT_REFUSE_RESCUE_LOW_RELATIONSHIP',
  ...
  FLORENCE_BREAK_CONTRACT_GAMBLING_WITH_ME: 'FLORENCE_BREAK_CONTRACT_GAMBLING_WITH_ME',
  ...
  FLORENCE_SIGN_CONTRACT_GAMBLING_WITH_ME: 'FLORENCE_SIGN_CONTRACT_GAMBLING_WITH_ME',
...
export const EventData = [
  {
    id: EVENT_ID.MAX_SIGN_CONTRACT_GAMBLING_WITH_ME,
  ...
  {
    id: EVENT_ID.FLORENCE_SIGN_CONTRACT_GAMBLING_WITH_ME,
  ...
  {
    id: EVENT_ID.MAX_BANKRUPT_HAS_DEBT_LOW_RELATION,
      ...
      sendMessage(MESSAGE_TYPE.FINANCE, this.title, this.body, [
        {
          ...
          payload: {
            ...
            currency: 'CR',
            resolveType: 'ACCEPT',
            nextEvent: partner.relationship < 20 ? EVENT_ID.MAX_BANKRUPT_ACCEPT_RESCUE_LOW_RELATIONSHIP : EVENT_ID.MAX_BANKRUPT_ACCEPT_RESCUE,
          }
        },
        {
          ...
          payload: {
            ...
            currency: 'CR',
            resolveType: 'REFUSE',
            failEvent: partner.relationship < 20 ? EVENT_ID.MAX_BANKRUPT_REFUSE_RESCUE_LOW_RELATIONSHIP : EVENT_ID.MAX_BANKRUPT_REFUSE_RESCUE
          }
        }
      ], this.sender)
    },
  ...
  {
    id: EVENT_ID.MAX_BANKRUPT_ACCEPT_RESCUE_LOW_RELATIONSHIP,
  ...
  {
    id: EVENT_ID.MAX_BANKRUPT_REFUSE_RESCUE_LOW_RELATIONSHIP,
      ...
      sendMessage(MESSAGE_TYPE.FINANCE, this.title, this.body, [
        {
          ...
          payload: {
            ...
            currency: 'CR',
            resolveType: 'ACCEPT',
            nextEvent: partner.relationship < 20 ? EVENT_ID.FLORENCE_BANKRUPT_ACCEPT_RESCUE_LOW_RELATIONSHIP : EVENT_ID.FLORENCE_BANKRUPT_ACCEPT_RESCUE,
          }
        },
        {
          label: this.label_refuse,
          ...
          payload: {
            ...
            currency: 'CR',
            resolveType: 'REFUSE',
            failEvent: partner.relationship < 20 ? EVENT_ID.FLORENCE_BANKRUPT_REFUSE_RESCUE_LOW_RELATIONSHIP : EVENT_ID.FLORENCE_BANKRUPT_REFUSE_RESCUE
          }
        }
      ], this.sender)
    },
  ...
  {
    id: EVENT_ID.FLORENCE_BANKRUPT_HAS_DEBT_LOW_RELATION,
      ...
      sendMessage(MESSAGE_TYPE.FINANCE, this.title, this.body, [
        ...
        },
        {
          ...
          payload: {
            amount: 0,
            resolveType: 'REFUSE',
            failEvent: EVENT_ID.FLORENCE_BANKRUPT_REFUSE_RESCUE
          }
        }
      ], this.sender)
    },
  ...
  {
    id: EVENT_ID.FLORENCE_BANKRUPT_ACCEPT_RESCUE_LOW_RELATIONSHIP,
  ...
  {
    id: EVENT_ID.FLORENCE_BANKRUPT_REFUSE_RESCUE_LOW_RELATIONSHIP,
  ...
  {
    id: EVENT_ID.MAX_BREAK_CONTRACT_GAMBLING_WITH_ME,
    title_ko: '혼자 다녀라',
  ...
  {
    id: EVENT_ID.FLORENCE_BREAK_CONTRACT_GAMBLING_WITH_ME,
    title_ko: '동행의 종료',
