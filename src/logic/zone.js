...
export const zones = [
  {
    ...
    "locations": [
      ...
      },
      {
        ...
        "description_ko": "네온 불빛이 비치는 좁은 골목, 반쯤 닫힌 가게 안 접이식 테이블 위의 소소한 모임.",
        "description_en": "Neon-lit alleys and folding tables: a cozy hideout behind half-closed shutters.",
  ...
  },
  {
    ...
    "locations": [
      ...
      },
      {
        ...
        "imgSrc": imgMicroWarehouse,
        "description_ko": "버려진 지하의 불법 판돈. 부랑자들과 절박한 이들을 위한 피난처.",
        "description_en": "Illegal stakes in a derelict basement. A haven for the street-dwellers and the desperate.",
        "requirements": null,
        "firstClearRewards": 'underground_bar_invite',
        "level": 2,
        "npcs": [
      ...
      },
      {
        ...
        "description_ko": "겉으로는 평범한 술집처럼 보이지만, 기지가 넘치는 이들을 위한 비밀 아지트. [입장 방법: 오직 암호뿐].",
        "description_en": "Looks like an ordinary bar on the outside, but it's a secret hideout for the sharp-witted. [Entry: Password only].",
        "level": 3,
