export const ITEM_EFFECT_DATA = [
  ...
  },
  {
    ...
    trigger: ['passive'],
    editable: false,
    get desc() { return `시간당 LT +${this.value}` },
    value: 1,
    isStackable: true
  },
  {
  ...
  },
  {
    ...
    rarity: 'Rare',
    cooldown: 0,
    trigger: ['showdownLoseWithAllIn'],
    editable: false,
    get desc() { return `올인 패배시 쇼다운 시점 기준 승률의 ${this.value * 100}% 만큼 CR 보전` },
    value: .25,
    isStackable: true
  },
  {
    ...
    trigger: ['gainXP'],
    editable: false,
    get desc() { return `획득하는 경험치의 ${this.value}배 만큼의 CR이 뱅크롤에 추가됩니다.` },
    value: 20,
    isStackable: true
  },
  {
    ...
    get desc() { return `올인 승리시 올인 시점 기준 역전할 확률(100-승률)% 만큼 본인 지분의 팟 보너스` },
    value: 0.5,
    isStackable: true
  },
  {
    ...
    unique: true,
    trigger: ['win'],
    get desc() { return `승리시 커뮤니티 보드와 자신의 손패에서 (다이아 문양 수 * 10)% 만큼 본인 지분의 팟 보너스` },
    value: 0.1,
    isStackable: false
  },
  {
    ...
    unique: true,
    trigger: ['win'],
    get desc() { return `승리시 커뮤니티 보드와 자신의 손패에서 (하트 문양 수 * 10)% 만큼 본인 지분의 팟 보너스` },
    value: 0.1,
    isStackable: false
  },
  {
    ...
    editable: false,
    trigger: ['win'],
    get desc() { return `승리시 커뮤니티 보드와 자신의 손패에서 (스페이드 문양 수 * 10)% 만큼 본인 지분의 팟 보너스` },
    value: 0.1,
    isStackable: false
  },
  {
    ...
    editable: false,
    trigger: ['win'],
    get desc() { return `승리시 커뮤니티 보드와 자신의 손패에서 (클럽 문양 수 * 10)% 만큼 본인 지분의 팟 보너스` },
    value: 0.1,
    isStackable: false
  },
  {
  ...
  },
  {
    ...
    editable: false,
    trigger: ['passive'],
    get desc() { return `보유 칩이 25BB 이하일 때 LT 회복량 ${this.value * 100}% 증가` },
    value: 1.0,
    isStackable: true
  },
  {
