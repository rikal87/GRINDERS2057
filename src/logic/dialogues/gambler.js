...
export const GAMBLER_DIALOGUE = {
  ...
  [CHAT_TRIGGERS.BIG_POT_TENSION]: {
    ...
    ko: [
      ...
      "저 칩 산더미... 희망의 빛이 쏟아지는 것 같네.",
      "막대한 재원이야! 여기서 진정한 도박꾼이 누군지 가려보자고.",
      "거대 팟이다! 가즈아아! 더 크게 가보자고!"
    ]
  },
  [CHAT_TRIGGERS.WIN_HERO_CALL]: {
    ...
    ko: [
      "뻥카인 거 다 알고 있었어! 내 흐름은 틀리지 않지. 하하하!",
  ...
  [CHAT_TRIGGERS.RERAISE]: {
    ...
    ko: [
      "레이즈를 한다고? 리레이즈! 판을 지옥불로 만들어주마!",
      "난 절대 굴복 안 해! 리레이즈! 리스크를 더 키워보자고!",
      "아드레날린 수치 폭발 직전! 리레이즈.",
      "모든 걸 건 도박이다. 리레이즈.",
      "불꽃 속에서 결투다, 리레이즈."
    ]
  ...
  [CHAT_TRIGGERS.CHECK_GOOD]: {
    ...
    ko: [
      "나도 체크! 폭발할 카드를 기다려야 겠네.",
      "공짜 카드 좀 보고 꿈을 쫓아보겠어. 체크.",
      "압박을 일단 억누르고. 체크백.",
      "네 차례다, 도박꾼 동지. 내가 지켜보고 있어. 체크.",
      "혼돈의 대기 상태. 체크백."
    ]
  },
  [CHAT_TRIGGERS.FOLD_STRONG]: {
    ...
    ko: [
      ...
      "으아아! 이걸 폴드하기 정말 싫은데! 하지만... 폴드.",
      "다음 판을 위해 운을 좀 아껴야겠어. 폴드."
    ]
  }
};
